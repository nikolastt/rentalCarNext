...
const AddVeicle: React.FC = () => {
  ...
  return (
    <>
      <AppBar />
      <div className="mx-3">
        <h1 className="text-center">Adicionar Veículos</h1>

        <div className="flex justify-between w-full gap-3 mt-6">
          <FormControl sx={{ width: "50%" }} size="small" error={categoryError}>
            ...
            {categoryError && <FormHelperText>Campo em branco</FormHelperText>}
          </FormControl>
          <FormControl sx={{ width: "50%" }} size="small" error={gearError}>
            ...
            {gearError && <FormHelperText>Campo em branco</FormHelperText>}
          </FormControl>
        </div>
        ...
        <div className="flex w-full items-center h-[250px] mt-6 ">
          <Cards
            isTypeAddCar={true}
            car={car}
            width="100%"
